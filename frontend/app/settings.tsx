...
import { PrimaryButton } from '@frontend/shared/components';
import { Colors, Typography, Spacing, BorderRadius, Shadows } from '@frontend/theme';
import { IncomeEntry } from '@frontend/shared/types';
import { deleteIncome, getIncomes } from '@frontend/features/income/services/income';
import { formatCurrency, formatDateShort, getMonthlyIncomes } from '@frontend/shared/utils';
import { clearToken } from '@frontend/features/auth/services/auth';
...
export default function SettingsScreen() {
  ...
  const loadIncomes = async () => {
    try {
      ...
      setIncomes(data.sort((a: any, b: any) => new Date(b.date).getTime() - new Date(a.date).getTime()));
    } catch (error) {
